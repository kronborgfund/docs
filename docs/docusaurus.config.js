...
const config = {
  title: "Kronborg Foundation",
  staticDirectories: ['public', 'static'],
  tagline: "Supporting People with hidden disabilities",
  favicon: "img/favicon.ico",

  // Set the production url of your site here
  url: "https://www.kronborgfund.com",
  ...
  organizationName: "kronborgfund", // Usually your GitHub org/user name.
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: "https://github.com/kronborgfund/docs",
            label: "GitHub",
            position: "right",
          },
        ],
